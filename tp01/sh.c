...
/* Vinícius Correia Fonseca de Castro - 2019055044 */
...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     * para reportar o erro corretamente. 
     ...
     O IF abaixo verifica se o comando recebido é cd
     O if é necessário, para que o diretório seja de fato
     aleterado, fazendo com que o processo atual ocorra.
     Tambem são enviado erros específicos para o caso do
     diretório não ser alterado corretamente
     */
